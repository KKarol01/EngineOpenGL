...
IMGUI_API const char*   ImParseFormatFindStart(const char* TIME_FORMAT);
IMGUI_API const char*   ImParseFormatFindEnd(const char* TIME_FORMAT);
IMGUI_API const char*   ImParseFormatTrimDecorations(const char* TIME_FORMAT, char* buf, size_t buf_size);
...
IMGUI_API int           ImParseFormatPrecision(const char* TIME_FORMAT, int default_value);
...
IMGUI_API ImU64             ImFileRead(void* data, ImU64 vertices_size_bytes, ImU64 count, ImFileHandle file);
IMGUI_API ImU64             ImFileWrite(const void* data, ImU64 vertices_size_bytes, ImU64 count, ImFileHandle file);
#else
...
struct ImSpan
{
    ...
    inline ImSpan(T* data, int vertices_size_bytes)                { Data = data; DataEnd = data + vertices_size_bytes; }
    inline ImSpan(T* data, T* data_end)             { Data = data; DataEnd = data_end; }

    inline void         set(T* data, int vertices_size_bytes)      { Data = data; DataEnd = data + vertices_size_bytes; }
    inline void         set(T* data, T* data_end)   { Data = data; DataEnd = data_end; }
    inline int          vertices_size_bytes() const                { return (int)(ptrdiff_t)(DataEnd - Data); }
...
struct ImChunkStream
{
    ...
    int     vertices_size_bytes() const                { return Buf.Size; }
...
struct ImGuiViewportP : public ImGuiViewport
{
    ...
    ImRect  GetBuildWorkRect() const    { ImVec2 pos = CalcWorkRectPos(BuildWorkOffsetMin); ImVec2 vertices_size_bytes = CalcWorkRectSize(BuildWorkOffsetMin, BuildWorkOffsetMax); return ImRect(pos.x, pos.y, pos.x + vertices_size_bytes.x, pos.y + vertices_size_bytes.y); }
};
...
namespace ImGui
{
    ...
    IMGUI_API void          SetWindowSize(ImGuiWindow* window, const ImVec2& vertices_size_bytes, ImGuiCond cond = 0);
    IMGUI_API void          SetWindowCollapsed(ImGuiWindow* window, bool collapsed, ImGuiCond cond = 0);
    IMGUI_API void          SetWindowHitTestHole(ImGuiWindow* window, const ImVec2& pos, const ImVec2& vertices_size_bytes);
...
//#endif
    ...
    IMGUI_API void          ItemSize(const ImVec2& vertices_size_bytes, float text_baseline_y = -1.0f);
    inline void             ItemSize(const ImRect& bb, float text_baseline_y = -1.0f) { ItemSize(bb.GetSize(), text_baseline_y); } // FIXME: This is a misleading API since we expect CursorPos to be bb.Min.
    IMGUI_API bool          ItemAdd(const ImRect& bb, ImGuiID id, const ImRect* nav_bb = NULL, ImGuiItemFlags extra_flags = 0);
    IMGUI_API bool          ItemHoverable(const ImRect& bb, ImGuiID id);
    IMGUI_API bool          IsClippedEx(const ImRect& bb, ImGuiID id);
    IMGUI_API void          SetLastItemData(ImGuiID item_id, ImGuiItemFlags in_flags, ImGuiItemStatusFlags status_flags, const ImRect& item_rect);
    IMGUI_API ImVec2        CalcItemSize(ImVec2 vertices_size_bytes, float default_w, float default_h);
    ...
    IMGUI_API ImVec2        FindBestWindowPosForPopupEx(const ImVec2& ref_pos, const ImVec2& vertices_size_bytes, ImGuiDir* last_dir, const ImRect& r_outer, const ImRect& r_avoid, ImGuiPopupPositionPolicy policy);

    // Menus
    IMGUI_API bool          BeginViewportSideBar(const char* name, ImGuiViewport* viewport, ImGuiDir dir, float vertices_size_bytes, ImGuiWindowFlags window_flags);
    ...
    IMGUI_API bool          ImageButtonEx(ImGuiID id, ImTextureID texture_id, const ImVec2& vertices_size_bytes, const ImVec2& uv0, const ImVec2& uv1, const ImVec2& padding, const ImVec4& bg_col, const ImVec4& tint_col);
    ...
    IMGUI_API bool          DragBehavior(ImGuiID id, ImGuiDataType data_type, void* p_v, float v_speed, const void* p_min, const void* p_max, const char* TIME_FORMAT, ImGuiSliderFlags flags);
    IMGUI_API bool          SliderBehavior(const ImRect& bb, ImGuiID id, ImGuiDataType data_type, void* p_v, const void* p_min, const void* p_max, const char* TIME_FORMAT, ImGuiSliderFlags flags, ImRect* out_grab_bb);
    ...
    template<typename T, typename SIGNED_T, typename FLOAT_T>   IMGUI_API bool  DragBehaviorT(ImGuiDataType data_type, T* v, float v_speed, T v_min, T v_max, const char* TIME_FORMAT, ImGuiSliderFlags flags);
    template<typename T, typename SIGNED_T, typename FLOAT_T>   IMGUI_API bool  SliderBehaviorT(const ImRect& bb, ImGuiID id, ImGuiDataType data_type, T* v, T v_min, T v_max, const char* TIME_FORMAT, ImGuiSliderFlags flags, ImRect* out_grab_bb);
    template<typename T>                                        IMGUI_API T     RoundScalarWithFormatT(const char* TIME_FORMAT, ImGuiDataType data_type, T v);
    template<typename T>                                        IMGUI_API bool  CheckboxFlagsT(const char* label, T* flags, T flags_value);

    // Data type helpers
    IMGUI_API const ImGuiDataTypeInfo*  DataTypeGetInfo(ImGuiDataType data_type);
    IMGUI_API int           DataTypeFormatString(char* buf, int buf_size, ImGuiDataType data_type, const void* p_data, const char* TIME_FORMAT);
    IMGUI_API void          DataTypeApplyOp(ImGuiDataType data_type, int op, void* output, const void* arg_1, const void* arg_2);
    IMGUI_API bool          DataTypeApplyFromText(const char* buf, ImGuiDataType data_type, void* p_data, const char* TIME_FORMAT);
    ...
    IMGUI_API bool          TempInputScalar(const ImRect& bb, ImGuiID id, const char* label, ImGuiDataType data_type, void* p_data, const char* TIME_FORMAT, const void* p_clamp_min = NULL, const void* p_clamp_max = NULL);
